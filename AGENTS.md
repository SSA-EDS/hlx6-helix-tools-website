...
This project is the website for https://tools.entmseds.live/, which provides administrative and development tools used with AEM Edge Delivery Services (EDS).
...
The repository provides the basic structure, blocks, and configuration needed to run a complete site with `*.entmseds.live` as the backend.
...
- HTML5 semantic markup generated by the entmseds.live backend, decorated by our code
- Node.js tooling
...
- **Production Preview**: `https://main--helix-tools-website--adobe.entmseds.page/`
- **Production Live**: `https://main--helix-tools-website--adobe.entmseds.live/`
- **Feature Preview**: `https://{branch}--helix-tools-website--adobe.entmseds.page/`
...
4. Open a pull request to merge changes to `main`
   1. in the PR description, include a link to `https://{branch}--helix-tools-website--adobe.entmseds.page/{path}` with a path to a file that illustrates the change you've made. This is the same path you have been testing with locally. WITHOUT THIS YOUR PR WILL BE REJECTED
