    ...
    switch (errCode) {
      ...
      case 499:
        return {
          ...
          msg: 'This is likely due to CORS. Either use a CORS allow plugin or add a header <code>Access-Control-Allow-Origin: https://tools.{{BASE_DOMAIN}}.live</code> in your site config.',
        };
      default:
        return {
          title: 'Error',
