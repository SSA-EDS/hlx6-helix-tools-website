window.addEventListener('DOMContentLoaded', () => {
  ...
  link.rel = 'stylesheet';
  link.href = window.location.pathname !== '/tools/snapshot-admin/401-test.html' ? 'https://tools.{{BASE_DOMAIN}}.live/tools/snapshot-admin/401-styles.css' : '/tools/snapshot-admin/401-styles.css';
