...
const getViewUrl = (org, repo, path) => `https://main--${repo}--${org}.{{BASE_DOMAIN}}.page${formatDocPath(path) || ''}`;
const getLiveUrl = (org, repo, path) => `https://main--${repo}--${org}.{{BASE_DOMAIN}}.live${formatDocPath(path) || ''}`;
